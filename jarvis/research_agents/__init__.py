...
**REVIVED 2026-09-12:** `research/lab/service.py`의 `ResearchService._data_analyst_report()`가 24h 스로틀로 Data Analyst 에이전트를 호출(registry+readiness 실라이브 데이터 관찰, `ResearchAgentEngine` 경유).
